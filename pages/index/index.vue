<template>
    <view class="container999" @click="conClick" @touchstart="refreshStart" @touchmove="refreshMove"
          @touchend="refreshEnd">
        ...
        <movable-area style="height: 100vh; width: 100vw;position: absolute;bottom: 0;">
            <movable-view class="addBtnBox" style="padding-top:120upx;padding-bottom:120upx;" @touchmove.stop=""
                ...
                <scroll-view style="height: 100%;" scroll-y="true" @scrolltolower="lower1" scroll-with-animation
                    ...
                    <view class='content'>
                        <!-- <view v-if="listIndex == 0">
                                      我是第一页特有的内容我是第一页特有的内容我是第一页特有的内容我是第一页特有的内容我是第一页特有的内容我是第一页特有的内容我是第一页特有的内容</view>
...
export default {
    ...
    data() {
        return {
            ...
            isX: 0, //放在store统一管理
            isY: 999, //放在store统一管理
            tabTitle: ['公告', '新闻', '选择三', '选择四'], //导航栏格式 --导航栏组件
    ...
    methods: {
        ...
        backPageListInfo(info) {
            ...
            for (const obj of infoList) {
                //vue无法直接监听过于复杂的数据结构的改变
                this.$set(this.list, obj.index, obj.info);
            }
        },
