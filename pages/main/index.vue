<template>
    <view class="container" @click="conClick" @touchstart="refreshStart"
        ...
        <movable-area style="height: 100vh; width: 100vw;position: absolute;bottom: 0;">
            <movable-view class="addBtnBox" style="padding-top:120upx;padding-bottom:50upx;"
...
export default {
    ...
    data() {
        return {
            ...
            isX: 0, //放在store统一管理
            isY: 999, //放在store统一管理
            tabTitle: ['公告', '新闻', '快讯', '选择四'], //导航栏格式 --导航栏组件
            size: [0, 0, 0, 0], //记录下每个页面的已有数据
            list: [[], [], [], []] //数据格式
        };
    },
    onLoad(e) {
